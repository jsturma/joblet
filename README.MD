...
> **🤖 AI Agent Support:** Secure sandboxed code execution with resource controls and process isolation - enabling AI
> agents
...
- **Pre-built Runtimes**: Python (basic + ML), Java, GraalVM environments for faster job startup
