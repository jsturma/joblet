...
install_python() {
    ...
    # Check if Python 3.11 is available on the host (via bind mounts)
...
ensure_build_tools() {
    ...
    # Check if essential build tools are available (via bind mounts)
    local missing_tools=""
...
echo "  sudo apt-get update && sudo apt-get install python3.11 python3.11-pip"
exit 1
EOF
...
main() {
    echo "═══════════════════════════════════════════════════════════════"
    echo "Python 3.11 Runtime Installation (Ubuntu AMD64 - Host Safe)"
    echo "═══════════════════════════════════════════════════════════════"
