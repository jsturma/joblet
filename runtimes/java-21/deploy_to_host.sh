...
info "  2. Try template: ssh $USER@$HOST 'cd /opt/joblet/examples/java-21 && rnx run --workflow=jobs.yaml:hello-joblet'"
info "  3. Try Virtual Threads: ssh $USER@$HOST 'cd /opt/joblet/examples/java-21 && rnx run --workflow=jobs.yaml:virtual-threads'"
