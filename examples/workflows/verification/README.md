...
This directory contains negative test cases designed to verify that the workflow validation system correctly catches various types of errors before workflow submission.
...
- **Usage**: `rnx run --workflow=test-missing-volume.yaml`
...
- **Usage**: `rnx run --workflow=test-missing-runtime.yaml`
...
- **Usage**: `rnx run --workflow=test-circular-dependency.yaml`
...
- **Usage**: `rnx run --workflow=test-invalid-dependency.yaml`
...
- **Usage**: `rnx run --workflow=test-valid-workflow.yaml`
...
- **Usage**: `rnx run --workflow=test-missing-network.yaml`
...
- **Usage**: `rnx run --workflow=test-valid-builtin-networks.yaml`
...
- **Usage**: `rnx run --workflow=test-valid-custom-network.yaml`
...
- **Usage**: `rnx run --workflow=test-network-isolation.yaml`
